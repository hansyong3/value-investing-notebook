          ...
          return (
            ...
            >
              ...
              <input type="text"
                ...
                placeholder="标题"
                className="w-full px-3 pt-2.5 pb-1 text-xl font-bold text-gray-800 placeholder-gray-300 focus:outline-none bg-white border-b border-gray-100"
              />
              ...
              {isOpen ? (
                ...
                <div
                  className="px-3 py-2 text-lg text-gray-500 leading-relaxed line-clamp-4 cursor-pointer"
